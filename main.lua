...
Fling.Name = "Fling"
Fling.Parent = Frame_3
Fling.BackgroundColor3 = Color3.fromRGB(64, 64, 64)
...
UICorner_27.Parent = HideKeyLabel
...
UICorner_30.Parent = HideKeybind
...
UICorner_32.Parent = Home_2

UICorner_33.Parent = Frame_2
...
UICorner_34.Parent = GameSpecific
...
UICorner_35.Parent = PrisonHax_155615604
...
UICorner_36.Parent = JailMonkey_606849621
...
UICorner_37.Parent = UniversalUI
...
UICorner_39.CornerRadius = UDim.new(15, 15)
...
UICorner_41.CornerRadius = UDim.new(15, 15)
UICorner_41.Parent = Respawn

-- Scripts:

local function EVHZE_fake_script() -- Library.LocalScript 
...
coroutine.wrap(EVHZE_fake_script)()
local function PJUY_fake_script() -- Btools.LocalScript 
...
coroutine.wrap(PJUY_fake_script)()
local function QKPUGBF_fake_script() -- Fly.LocalScript 
...
coroutine.wrap(QKPUGBF_fake_script)()
local function UFLYO_fake_script() -- Jump.LocalScript 
...
coroutine.wrap(UFLYO_fake_script)()
local function TMEJJL_fake_script() -- Noclip.LocalScript 
...
coroutine.wrap(TMEJJL_fake_script)()
local function TYCTG_fake_script() -- ClickTP.LocalScript 
...
coroutine.wrap(TYCTG_fake_script)()
local function ZCHLF_fake_script() -- ClickDE.LocalScript 
...
coroutine.wrap(ZCHLF_fake_script)()
local function EZYIM_fake_script() -- Speed.LocalScript 
...
coroutine.wrap(EZYIM_fake_script)()
local function AOAO_fake_script() -- ESP.LocalScript 
...
coroutine.wrap(AOAO_fake_script)()
local function CJLCAW_fake_script() -- Freecam.LocalScript 
...
coroutine.wrap(CJLCAW_fake_script)()
local function QWFNBYR_fake_script() -- TextBox.LocalScript 
...
coroutine.wrap(QWFNBYR_fake_script)()
local function BDLELJO_fake_script() -- GoTo.LocalScript 
...
coroutine.wrap(BDLELJO_fake_script)()
local function RIYZK_fake_script() -- Spectate.LocalScript 
...
coroutine.wrap(RIYZK_fake_script)()
local function OGFMWQ_fake_script() -- Follow.LocalScript 
...
coroutine.wrap(OGFMWQ_fake_script)()
local function ZTOBWMM_fake_script() -- Annoy.LocalScript 
	...
	local hightAbovePlayer = 0
	local leftOrRightFromPlayer = 0
	local CFrameP = CFrame.new(leftOrRightFromPlayer, hightAbovePlayer, distanceFromPlayer)
	local newCF
	script.Parent.MouseButton1Up:Connect(function()
		if annoy == true then
			script.Parent.Text = 'Annoy'
			annoy = false
		elseif annoy == false then
			annoy = true
			script.Parent.Text = 'Annoying'
			while annoy == true do
				wait()
				newCF = workspace[script.Parent.Parent.Parent.TextBox.Text].HumanoidRootPart.CFrame:ToWorldSpace(CFrameP)
				plr.HumanoidRootPart.CFrame = newCF
			end
		end
	end)
...
coroutine.wrap(ZTOBWMM_fake_script)()
local function LNMDMKG_fake_script() -- Fling.LocalScript 
...
coroutine.wrap(LNMDMKG_fake_script)()
local function XTLMC_fake_script() -- HideKeybind.LocalScript 
...
coroutine.wrap(XTLMC_fake_script)()
local function ZJUY_fake_script() -- FlyKeybind.LocalScript 
...
coroutine.wrap(ZJUY_fake_script)()
local function PTIFS_fake_script() -- TextLabel.LocalScript 
	local script = Instance.new('LocalScript', TextLabel)

	local PLAYERNAME1 = game.Players.LocalPlayer.DisplayName
	script.Parent.Text = 'Welcome '.. PLAYERNAME1 ..','
end
coroutine.wrap(PTIFS_fake_script)()
local function WPOFMXN_fake_script() -- GameSpecific.GameID 
...
coroutine.wrap(WPOFMXN_fake_script)()
local function LVXGCH_fake_script() -- PrisonHax_155615604.LocalScript 
...
coroutine.wrap(LVXGCH_fake_script)()
local function OJQPKX_fake_script() -- JailMonkey_606849621.LocalScript 
...
coroutine.wrap(OJQPKX_fake_script)()
local function MYKQXE_fake_script() -- UniversalUI.LocalScript 
...
coroutine.wrap(MYKQXE_fake_script)()
local function MKBU_fake_script() -- Frame.DraggableScript 
	local script = Instance.new('LocalScript', Frame)
...
coroutine.wrap(MKBU_fake_script)()
local function YDIYRVG_fake_script() -- Close.LocalScript 
	local script = Instance.new('LocalScript', Close)
...
coroutine.wrap(YDIYRVG_fake_script)()
local function QLPE_fake_script() -- Frame.Opening 
	local script = Instance.new('LocalScript', Frame)
...
coroutine.wrap(QLPE_fake_script)()
local function JCSVKAX_fake_script() -- Minimize.LocalScript 
...
coroutine.wrap(JCSVKAX_fake_script)()
local function RFAKD_fake_script() -- Respawn.LocalScript 
...
coroutine.wrap(RFAKD_fake_script)()
local function WXLPLH_fake_script() -- Universal.HideScript 
	...
	mouse.KeyUp:connect(function(key)
		if key:lower() == keybind and guiIn == true then
			script.Parent.Frame:TweenPosition(UDim2.new(-1, 0, 0.3569,0)
				"Out", "Elastic", 2, true
			)
			guiIn = false
		elseif key:lower() == keybind and guiIn == false then
			script.Parent.Frame:TweenPosition(UDim2.new(0.35, 0,0.3569, 0)
				"Out", "Elastic", 1, true
			)
			guiIn = true
		end
...
coroutine.wrap(WXLPLH_fake_script)()
local function HTNN_fake_script() -- Universal.ToAdd 
	local script = Instance.new('LocalScript', Universal)
...
coroutine.wrap(HTNN_fake_script)()
